...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=be88bf9a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_vm._ssrNode("<h1 class=\"survey-h1\">Добавить опрос</h1> "),_vm._ssrNode("<div class=\"survey-cards\">","</div>",_vm._l((_vm.cards),function(card,index){return _vm._ssrNode("<div class=\"card\">","</div>",[(card)?_c('SurveySection',{attrs:{"data":card,"index":index}}):_vm._e()],1)}),0),_vm._ssrNode(" <button class=\"big-button\">\n    Нажмите чтобы добавить новое условие выборки\n  </button> "),_c('nuxt-link',{staticClass:"big-button",attrs:{"to":"/survey"}},[_vm._v(" Проверить опрос ")])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=be88bf9a&
